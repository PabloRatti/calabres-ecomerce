    ...
    return (
      <HomeContainer>
        <Image
          ...
          src={require("../img/yellowCar.jpg")}
          fluid
        />
        <Carousel className="carousel" />

        <PresentationCard
          image2={require("../img/llantas2.jpg")}
          image={require("../img/neumaticos.jpg")}
        />

        <Image
          className="brands"
          src={require("../img/MarcasCalabres.png")}
          fluid
        />
        {/*<HorizontalGallery />*/}
        <PresentationCard2
          image2={require("../img/carretera2.jpg")}
          image={require("../img/pickupcalabres.jpg")}
        />
